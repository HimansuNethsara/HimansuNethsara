...
<head>
    ...
    <!-- Title Tag  -->
    <title>Manage Products | Admins | Trendy_tech</title>
    <!-- Favicon -->
...
<header class="header shop">
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="manageProduct.php">Product Management</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="shopping-cart section">
        <div class="container">
        <h1 class="report-title">Product Management</h1>
            <div class="row">
                <div class="col-12">
                    ...
                    <table class="table shopping-summery">
                        ...
                        for ($x = 0; $x < $selected_num; $x++) {
                            ...
                            <tr>
                                <td style="text-align: center;"><span><?php echo $selected_data["id"]; ?></span></td>
                                <td class="image" data-title="No">
                                    ...
                                    ?>
                                        <img src="<?php echo $image_data["img_path"]; ?>" style="height: 80px; width:80px;" />
                                    <?php
                                    }
                                    ?>
                                </td>
                                <td style="text-align: center;"><span onclick="viewProductModal('<?php echo $selected_data['id']; ?>');"><?php echo $selected_data["title"]; ?></span></td>
                                <td style="text-align: center;"><span>Rs. <?php echo $selected_data["price"]; ?> .00</span></td>
                                <td style="text-align: center;"><span><?php echo $selected_data["qty"]; ?></span></td>
                                <td style="text-align: center;"><span><?php echo $selected_data["datetime_added"]; ?></span></td>
                                <td style="text-align: center;">
                                    <?php
                                    if ($selected_data["status_status_id"] == 1) {
                                    ?>
                                        <button id="pb<?php echo $selected_data['id']; ?>" onclick="blockProduct('<?php echo $selected_data['id']; ?>');" class="btn btn-danger col-12">Block
                                        </button>
                                    <?php
                                    } else {
                                    ?>
                                        <button class="btn btn-success col-12 me-2" id="pb<?php echo $selected_data['id']; ?>" onclick="blockProduct('<?php echo $selected_data['id']; ?>');">Unblock</button>
                                    <?php
                                    }
