...
$query = "SELECT `users`.`fname`,`users`.`lname`,`users`.`email`,`users`.`mobile`,`users`.`status`,users_has_address.line1,users_has_address.line2,city.city_name FROM `users` INNER 
JOIN `status` ON `status`.`status_id` = `users`.`status` INNER JOIN `users_has_address` ON `users_has_address`.`users_email`=users.email INNER JOIN city ON users_has_address.city_city_id = city.city_id ;";
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="watchlist.php">User Report</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table shopping-summery">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;"><span><?php echo $d["fname"]; ?></span></td>
                                <td style="text-align: center;"><span><?php echo $d["lname"]; ?></span></td>
                                <td style="text-align: center;"><span><?php echo $d["email"]; ?></span></td>
                                <td style="text-align: center;"><span><?php echo $d["mobile"]; ?></span></td>
                                <td style="text-align: center;"><span><?php echo $d["line1"] . " " . $d["line2"]; ?></span></td>
                                <td style="text-align: center;"><span><?php echo $d["city_name"]; ?></span></td>
                                <td style="text-align: center;"><span><?php echo $d["status"]; ?></span></td>
                            </tr>
                            <?php
                            }
                            ?>
